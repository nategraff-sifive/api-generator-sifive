...
def search_json(js_obj: JsonType, regex: re.Pattern) -> t.Generator:
    """
    Search a json objec for any key or string matching regex. Return a
    generator for thos objects.

    :param js_obj: A parsed javascript object
    :param regex: a regex to search for.
    :return:A generator of matching parts
    """
...
def generate_protos(device_name: str, reg_list: t.List[Register]):
    """
    Generate the function protoypes for a given device and register list.
